...
<?php
$webnameA = "Autónomos";
$webnameB = "SerInformaticos";
$slogan ="Sistema de ayuda para autónomos";
include("$inc/softinfo.php");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Autónomos - SerInformaticos</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><span><?php echo $webnameA; ?></span><?php echo $webnameB; ?><br />
          <small><?php echo $slogan; ?></small></h1>
      </div>
