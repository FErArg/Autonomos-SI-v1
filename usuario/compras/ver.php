...
<pre>
<?php
	$query0="select * from compras";
	$query=mysql_query($query0);
	print "<table border=0 width=\"90%\">\n";
	print "<tr>\n";
	print "<td>Año </td><td>Trim </td><td>Fecha </td><td>Proveedor </td><td>Detalle </td><td>Nro. </td><td>Base </td><td>IVA </td><td>Total </td><td>Pagada </td>\n";
	print "</tr>\n";
	$i=1;
