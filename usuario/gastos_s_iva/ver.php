...
<pre>
<?php
	$query0="select * from gastos_s_iva";
	$query=mysql_query($query0);
	print "<table border=0 width=\"90%\">\n";
	print "<tr>\n";
	print "<td>Año </td><td>Trim </td><td>Fecha </td><td>Proveedor </td><td>Detalle </td><td>Nro. </td><td>Total </td><td>Pagada </td>\n";
	print "</tr>\n";
	$i=1;
	while( $rec3 = mysql_fetch_row($query) ){
		...
		print "<tr>";
		print "<td>". $rec3[1] ."</td><td>". $rec3[2] ."</td><td>". $rec3[3] ."</td><td>". $rec3[4] ."</td><td>". $rec3[5] ."</td><td>". $rec3[6] ."</td><td>". $rec3[8] ."</td><td>". $estado ."</td>\n";
		print "</tr>";
	}
	print "</table>\n";
?>
