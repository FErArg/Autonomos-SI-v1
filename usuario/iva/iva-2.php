...
print("<table style=\"text-align: left; width: 80%;\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\">");
	print("<tbody>");
		...
		print ("<tr>");
			...
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
				$gastosmascompras=( $compras[2] + $gastos[2] ); 
				print $gastosmascompras;
			print ("</td>");
		print ("</tr>\n");
		print ("<tr>");
			print ("<td style=\"vertical-align: top;\">");
			...
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
				$ivagastosmascompras=( $compras[3] + $gastos[3] ); 
				print $ivagastosmascompras;
			print ("</td>");
		print ("</tr>\n");
		print ("<tr>");
			print ("<td style=\"vertical-align: top;\">");
				print ("Casilla 38 / 40 / 46 / 48");
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
				$iva=( $ventas[3] - ( $compras[3] + $gastos[3] ) );
				print $iva;
			print ("</td>");
		print ("</tr>\n");
	print("</tbody>");
