...
<form action="ventas-2.php" method="post">
	...
	<tbody>
		<tr>
			...
			<td style="vertical-align: top; text-align: center;">Cobrada</td>
		</tr>
<?php
$max='10';
...
for ($i = 1; $i <= $max; $i++) {
	$valor = $i;
		print ("<tr>");
			...
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
			print ("<input type=\"text\" name=\"cliente[".$valor."]\" size=15 value=\"\" />");
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
			...
			print ("</td>");
			print ("<td style=\"vertical-align: top;\">");
				print ("<select name=\"cobrada[".$valor."]\">");
